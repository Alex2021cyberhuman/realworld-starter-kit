...
namespace Conduit.Auth.Domain.Services.DataAccess
{
    ...
    {
        private static MethodInfo _genericMethod = typeof(IUnitOfWork)
            .GetMethod(nameof(IUnitOfWork.GetRepository),
                BindingFlags.Public | BindingFlags.Instance)!;

        public static object? GetRepository(
            this IUnitOfWork unitOfWork, Type repositoryType)
        {
        ...
        public static TRepository GetRequiredRepository<TRepository>(
            ...
            unitOfWork.GetRepository<TRepository>() ??
